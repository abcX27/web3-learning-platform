...
router.get('/:id', auth_1.optionalAuthenticate, courseController.getChapterById);
// Protected routes - requires authentication
router.post('/:id/complete', auth_1.authenticate, courseController.markChapterComplete);
